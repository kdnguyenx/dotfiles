...
" timeout behaviour
set ttimeout ttimeoutlen=500 timeoutlen=500
...
nnoremap <leader>g :vimgrep //f **
vnoremap <leader>g "0y:vimgrep /<c-r>0/f **
...
" indent by filetypes
autocmd filetype c,cpp,python,java setlocal expandtab shiftwidth=4 tabstop=4 softtabstop=4
